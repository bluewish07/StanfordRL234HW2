...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        if t < 0:
            ...
            self.epsilon = float(self.eps_end - self.eps_begin) / float(self.nsteps) * t + self.eps_begin
...
def your_test():
    ...
    """
    env = EnvTest((5, 5, 1))
    exp_strat = LinearExploration(env, 0.7, 0.5, 10)
    exp_strat.update(5)
    assert exp_strat.epsilon == 0.6, "Test 4 failed"
    print("Test4: ok")
